...
import { CalendarClock, List, LayoutGrid, Loader2, Plus, Calendar as CalendarIcon } from 'lucide-react';
...
import { getEvents, addEvent, AddEventInput } from './actions';
...
function AddEventForm({ setIsOpen, onEventAdded }: { setIsOpen: (open: boolean) => void, onEventAdded: () => void }) {
      ...
      {role === 'admin' && (
         <Dialog open={isAddEventOpen} onOpenChange={setIsAddEventOpen}>
            ...
            <DialogContent className="sm:max-w-[480px]">
                ...
                <AddEventForm setIsOpen={setIsAddEventOpen} onEventAdded={fetchPageEvents} />
            </DialogContent>
         </Dialog>
      )}
